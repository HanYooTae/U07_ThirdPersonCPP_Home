...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(FOnBehaviorTypeChangedSignature, EBehaviorType, InPrevType, EBehaviorType, InNewType);
...
public:
	UPROPERTY(BlueprintAssignable)
		FOnBehaviorTypeChangedSignature OnBehaviorTypeChanged;
...
private:
	class UBlackboardComponent* Blackboard;		// CAIController에 있는 Blackboard를 가져오려고 만든 변수. 새로 생성하는 컴포넌트가 아니기 때문에 VisibleDefaultOnly를 붙이면 안됨.
};
